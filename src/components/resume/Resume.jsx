          ...
          <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                className="flex items-center gap-2 rounded-xl bg-red-500 px-6 py-3 font-semibold transition hover:bg-red-600"
              >
                <FaEye />
                Preview
              </a>
              ...
              <a
                href="/resume/Ian_Muema_CV.pdf"
                download
                className="flex items-center gap-2 rounded-xl border border-white/10 px-6 py-3 transition hover:bg-white/10"
              >
                <FaDownload />
                Download
              </a>
